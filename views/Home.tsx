      ...
      <section className="min-h-[80vh] flex flex-col justify-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-[#D8D8D8] font-light max-w-4xl mb-12 leading-[1.6]">
            ...
            stratejisinin, hikayesi olan tasarımların, gündemi takip eden zengin
            içeriklerin ve etkili yapay zeka kullanımının buluştuğu bir
            laboratuvardır.
          </p>
        ...
        <div className="space-y-8">
          ...
          <blockquote className="border-l-2 border-[#FF2EB8] pl-8 py-2">
            <p className="text-xl italic font-light text-[#A8A8A8]">
              "Yaratıcılık kaosa teslim olursa, düzeni biz kurarız."
            </p>
          </blockquote>
        </div>
      </section>
